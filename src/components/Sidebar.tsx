          ...
          <div className="border-t border-gray-800 p-4">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-left text-gray-300 hover:text-white hover:bg-gray-800 transition-colors"
              >
              ...
              {profileDropdown && (
                <div className="absolute bottom-full left-0 right-0 mb-2 bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 w-full px-3 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-gray-700 transition-colors"
                  >
